...
public class Converter {
    ...
    public MelodyStruct convertMusicStringToMelodyStruct(String musicString) {
    ...
    public BinaryPattern convertMusicStringToBinaryPattern(String musicString) {
        ...
        System.out.println(this.convertDoubleArrayToString(durationsArray));
        ...
        System.out.println("DURATIONSINTARRAY" + this.convertIntArrayToString(durationsIntArray));
    ...
    public double[] getDurations(String musicString) {
        ...
        System.out.println("In getDurations");
    ...
    public String convertMelodyStructToLilyPond(MelodyStruct melody) {
        ...
        System.out.println("In ConvertMelodyStructToLilyPond");
        String[] lilyNotes = new String[midiNoteValues.length];
        System.out.println(this.convertStringArrayToString(melody.chromatic));
